...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageButton topBarBack, @NonNull View topBarDivider, @NonNull TextView topBarTitle) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.top_bar_back;
      ImageButton topBarBack = ViewBindings.findChildViewById(rootView, id);
      if (topBarBack == null) {
        break missingId;
      }

      id = R.id.top_bar_divider;
      View topBarDivider = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((LinearLayout) rootView, bottomNavigation, fragmentContainer,
          topBar, topBarBack, topBarDivider, topBarTitle);
    }
