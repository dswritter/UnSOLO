-- Explicit trip days/nights, return dates per departure, travel-day exclusion flag, dep/return times
...
-- Backfill return_dates from departure_dates + duration_days (inclusive span)
UPDATE packages p
