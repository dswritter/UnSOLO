...
export function WanderHero({
  ...
  return (
    <section className="relative w-full min-h-[clamp(260px,40vh,440px)] overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex min-h-[clamp(260px,40vh,440px)] w-full max-w-[min(100%,1920px)] flex-col justify-between gap-5 px-4 pb-5 pt-6 sm:px-6 md:pb-6 md:pt-8 lg:px-10">
        <div className="min-w-0 max-w-3xl">
          <p
            className="mb-3 inline-flex max-w-md items-center gap-2 rounded-lg border border-primary/30 bg-primary/8 px-3 py-2 text-left text-xs font-medium leading-snug text-white shadow-sm backdrop-blur-md ring-1 ring-white/5 sm:text-[13px]"
            style={{ WebkitBackdropFilter: 'blur(14px)' }}
          >
            <ShieldCheck
              className="h-4 w-4 shrink-0 text-[#fcba03]"
              strokeWidth={2}
              aria-hidden
            />
            <span>India&apos;s most trusted solo travel community</span>
          </p>
