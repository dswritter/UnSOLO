...
export function NotificationPrompt() {
  ...
  return (
    <div className="mx-4 mt-3 mb-1 p-3 rounded-xl bg-primary/10 border border-primary/30 flex items-center gap-3 shrink-0">
      ...
      <div className="flex items-center gap-1 shrink-0">
        <Button size="sm" className="h-7 text-xs bg-primary text-black px-3" onClick={requestPermission}>
          Allow
        </Button>
