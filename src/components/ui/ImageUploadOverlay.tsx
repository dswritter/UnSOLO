...
export function ImageUploadOverlay({
  ...
  subMessage?: string
  onCancel: () => void
  /** Extra content below the title row (e.g. a stats preview). */
  children?: ReactNode
  /** Root overlay z-index / layout (e.g. z-[600] to sit above other UI). */
  className?: string
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-black/55 backdrop-blur-sm pointer-events-auto ${backdropClassName ?? ''}`}
        aria-hidden
      />
