...
import { ProfileActions, OwnProfileFollowCounts } from '../../profile/[username]/ProfileActions'
import { PhoneRequestButton } from '../../profile/[username]/PhoneRequestButton'
...
export default async function ProfilePage({
  ...
  const profileShareUrl = `${APP_URL.replace(/\/$/, '')}/profile_v2/${profile.username}`
                ...
                <div className="flex flex-wrap gap-2 justify-end">
                  ...
                  {isOwnProfile ? (
                    <Button variant="outline" size="sm" className="border-border" asChild>
                      <Link href="/profile_v2/edit">Edit Profile</Link>
                    </Button>
                  ) : (
                    <ProfileActions
