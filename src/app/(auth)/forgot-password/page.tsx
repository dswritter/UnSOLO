              ...
              <div className="text-center space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <strong className="font-semibold text-foreground break-all">{email}</strong>. Open the
                ...
                <div className="flex flex-col items-center text-center sm:items-start sm:text-left gap-4 sm:flex-row sm:items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                      Enter the email for your account. We&apos;ll send a secure link — valid for a limited
                      time.
                    </p>
                  </div>
                </div>
